        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="da-img">
                        <img src="/wp-content/themes/wpt_mobile_catalog/demo/parallax-slider/images/2.png" alt="image01"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="da-img">
                        <img src="/wp-content/themes/wpt_mobile_catalog/demo/parallax-slider/images/3.png" alt="image01"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="da-img">
                        <img src="/wp-content/themes/wpt_mobile_catalog/demo/parallax-slider/images/1.png" alt="image01"/>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="feature-box">
                <div class="col-md-4 col-sm-4 text-center wow fadeInUp">
                    <div class="feature-box-heading">
                        <em>
                            <img src="/wp-content/themes/wpt_mobile_catalog/demo/1.png" alt="" width="100" height="100">
                ...
                <div class="col-md-4 col-sm-4 text-center wow fadeInUp">
                    <div class="feature-box-heading">
                        <em>
                            <img src="/wp-content/themes/wpt_mobile_catalog/demo/2.png" alt="" width="100" height="100">
                        </em>
                        <h4>
                            <b>Well Documented</b>
                        </h4>
                ...
                <div class="col-md-4 col-sm-4 text-center wow fadeInUp">
                    <div class="feature-box-heading">
                        <em>
                            <img src="/wp-content/themes/wpt_mobile_catalog/demo/3.png" alt="" width="100" height="100">
                        </em>
                        <h4>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-sm-6 text-center wow fadeInLeft">
                <img src="/wp-content/themes/wpt_mobile_catalog/demo/tab1.png" alt="">
            </div>
            <div class="col-lg-6 col-sm-6 wow fadeInRight">
                ...
                <p>
                    ...
                    totam rem aperiam, eaque ipsa quae ablic jiener. natus error sit voluptatem accusantium doloremque
                    laudantium, totam rem aperiam, eaque ipsa quae ablic jiener. natus error sit voluptatem accusantiu.
                </p>
                <p>
                    <i class="fa fa-check fa-lg pr-10">
                    </i>
                ...
                <div class="panel-body">
                    <div class="tab-content tasi-tab">
                        <div id="news" class="tab-pane fade in active">
                            <article class="media">
                                <a class="pull-left thumb p-thumb">
                                    <img src="/wp-content/themes/wpt_mobile_catalog/demo/product1.jpg" alt="">
                                </a>
                            ...
                            <article class="media">
                                <a class="pull-left thumb p-thumb">
                                    <img src="/wp-content/themes/wpt_mobile_catalog/demo/product2.jpg" alt="">
                                </a>
                                <div class="media-body b-btm">
                                    <a href="#" class=" p-head">
                        ...
                        <div id="notice-board" class="tab-pane fade">
                            <p>
                                Notice board goes here Sed ut perspiciatis unde omnis iste natus error sit voluptatem
                                accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ablic jiener.
                            </p>
                            <p>
                                Notice board goes here Sed ut perspiciatis unde omnis iste natus error sit voluptatem
                                accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ablic jiener.
                ...
                <section class="slider wow fadeInRight">
                    <div class="flexslider">
                        <ul class="slides about-flex-slides">
                            <li>
                                <div class="about-testimonial-image ">
                                    <img alt="" src="/wp-content/themes/wpt_mobile_catalog/demo/person_1.png">
                                </div>
                      ...
                      CCD Realestate
                                ...
                                <div class="about-testimonial-content">
                                    <p class="about-testimonial-quote">
                                        ...
                                        lectus a ligula lobortis pretium. Donec ut purus sed tortor malesuada venenatis
                                        eget eget lorem.
                                    </p>
                                </div>
                            </li>
                            <li>
                                <div class="about-testimonial-image ">
                                    <img alt="" src="/wp-content/themes/wpt_mobile_catalog/demo/person_2.png">
                                </div>
                                <a class="about-testimonial-author" href="#">
                                    Steven gerrard
                                </a>
                      ...
                      Molt BVG
                                ...
                                <div class="about-testimonial-content">
                                    <p class="about-testimonial-quote">
                                        Pellentesque et pulvinar enim. Quisque at tempor ligula. Maecenas augue ante,
    ...
    <div class="row mar-b-50 our-clients">
        ...
        <div class="col-md-9">
            ...
            <ul class="bxslider1 clients-list">
                <li>
                    <a href="#">
                        <img src="/wp-content/themes/wpt_mobile_catalog/demo/clients/graylogo6.png" alt=""/>

                        <img src="/wp-content/themes/wpt_mobile_catalog/demo/clients/newlogo6.png" class="color-img" alt=""/>
                    </a>
                </li>
                <li>
                    <a href="#">
